"""
    # Copied from mitmproxy/netlib/http project
    # Original's GitHub: https://raw.githubusercontent.com/mitmproxy/netlib/master/netlib/http_uastrings.py
